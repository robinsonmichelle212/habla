...
function SummaryScreenInner({
  ...
  const buildLessonHistoryEntry = useCallback(() => {
    ...
    try {
      ...
      console.log('Grammar data:', breakdown.grammar);
      console.log('Vocabulary data:', breakdown.vocabulary);
      console.log('Fluency data:', breakdown.fluency);
      console.log('Writing data:', breakdown.writing);
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <ScrollView
        contentContainerStyle={[
          ...
          { paddingBottom: mode === 'summary' && hasAnalysis ? 76 : 14 },
        ]}
...
const styles = StyleSheet.create({
  ...
  gemsEarnedEmoji: { fontSize: 32, marginBottom: 3 },
  gemsEarnedTitle: {
    fontSize: 11,
    fontWeight: '900',
    color: palette.muted,
